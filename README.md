...
2. 打 tag 推送：`traework-v0.1.22` / `workbuddy-v0.1.38` / `qoder-v0.1.8`（版本以 tag 为准）
...
| 应用 | 当前版本 | 版本线起点 |
|---|---|---|
| TraeWorkAssistant | `0.1.22` | 0.1.x（自身历史） |
| WorkBuddyAssistant | `0.1.38` | 0.1.x（自身历史） |
| QoderAssistant | `0.1.8` | **从 `0.1.0` 起算** |
