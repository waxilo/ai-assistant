...
2. 打 tag 推送：`traework-v0.1.21` / `workbuddy-v0.1.37` / `qoder-v0.1.7`（版本以 tag 为准）
...
| 应用 | 当前版本 | 版本线起点 |
|---|---|---|
| TraeWorkAssistant | `0.1.21` | 0.1.x（自身历史） |
| WorkBuddyAssistant | `0.1.37` | 0.1.x（自身历史） |
| QoderAssistant | `0.1.7` | **从 `0.1.0` 起算** |
